...
class SeriesByCharacterResponse {
  SeriesByCharacterResponse({
    required this.code,
  ...
  SeriesByCharacterResponse.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
...
extension GetCharacterSeriesResponseExtension on Results {
  Serie toDomain() {
    return Serie(
      id: id,
      title: title,
