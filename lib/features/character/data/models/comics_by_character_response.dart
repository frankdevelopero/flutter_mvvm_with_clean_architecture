...
class ComicsByCharacterResponse {
  ComicsByCharacterResponse({
    required this.code,
  ...
  ComicsByCharacterResponse.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
...
class Results {
  ...
  Results.fromJson(Map<String, dynamic> json) {
    ...
    collectedIssues = List.from(json['collectedIssues'])
...
extension GetComicsResponseExtension on Results {
  Comic toDomain() {
    return Comic(
      id: id,
      title: title,
